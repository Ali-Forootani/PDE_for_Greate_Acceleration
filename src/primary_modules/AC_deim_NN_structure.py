...
print(torch.round(model_1.constraint.coeff_vectors[0].detach().cpu(), decimals=3))
print(torch.round(model_2.constraint.coeff_vectors[0].detach().cpu(), decimals=3))
print(torch.round(model_3.constraint.coeff_vectors[0].detach().cpu(), decimals=3))
